...
const DoctorRequests = () => {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'admin-dark bg-gray-900 text-white' : 'bg-white text-gray-900'}`} style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
          ...
          <div className="overflow-x-auto">
            {filteredDoctors.length === 0 ? (
              ...
              <div className="text-center py-20">
                <div className={`w-32 h-32 mx-auto mb-8 rounded-full flex items-center justify-center transition-colors duration-300 ${isDarkMode ? 'bg-gray-800 border-2 border-gray-700' : 'bg-gray-50 border-2 border-gray-200'
                  }`}>
                    ...
                    <tr key={doctor.id} className={`border-b transition-all duration-200 ${isDarkMode ? 'border-gray-700 hover:bg-gray-800' : 'border-gray-100 hover:bg-blue-50'}`}>
                      ...
                      <td className="py-4 px-4">
                        <div>
                          ...
                          <span className={`inline-block text-xs px-2 py-1 rounded-full font-medium mt-1 ${doctor.priority === 'high' ? 'bg-red-100 text-red-700' :
                      ...
                      <td className="py-4 px-4">
                        <div>
                          <span className={`inline-block text-xs px-3 py-1 rounded-full font-medium ${doctor.verification === 'verified' ? 'bg-emerald-100 text-emerald-700' :
                      ...
                      <td className="py-4 px-4">
                        <span className={`inline-block text-xs px-3 py-1 rounded-full font-semibold ${doctor.status === 'pending' ? 'bg-amber-100 text-amber-700' :
